...
Web.Editor.prototype = {
			...
			if (obj) {
				...
				if (tid) {
					...
					"<table border=0 cellspacing=2 cellpadding=0 class=alc-cntxt-box><tr><td><table border=0 cellspacing=0 cellpadding=2 class=alc-cntxt-bs>"+
						"<tr><td rowspan=5 class=alc-cntxt-main><img src="+Alice.config.imageroot+"alice/editor/table_row.gif></td><td rowspan=5 valign=top style=padding-top:4;width:70><b>행 옵션</td><td onclick=\"Alice.table.appendRowBefore('"+alice+"','"+tid+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>위에 행 추가</td></tr>"+
						...
						"<tr><td onclick=\"Alice.color.togglePicker('"+d1+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>해당행 배경색 <div style=position:absolute;left:300;width:200px;display:none id='"+d1+"' onclick=\"Alice.table.colorRow('"+alice+"','"+tid+"')\"></div></td></tr>"+
						"<tr><td class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>해당행 높이조절 <input type=text id=unc-tab-hei-conf title='해당행 높이조절' style='width:40;height:15px;font-size:10px;'> <span onclick=\"Alice.table.rapHeightCol('"+alice+"','"+tid+"')\" style='cursor:pointer'>입력</span></td></tr>"+
						...
						"<tr><td onclick=\"Alice.color.togglePicker('"+d2+"')\" class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>해당열 배경색 <div style=position:absolute;left:300;width:200px;display:none id='"+d2+"' onclick=\"Alice.table.colorCol('"+alice+"','"+tid+"')\"></div></td></tr>"+
						"<tr><td class=alc-cntxt-sub onmouseover=this.className='alc-cntxt-sub-o' onmouseout=this.className='alc-cntxt-sub'>해당열 너비조절 <input type=text id=unc-tab-wid-conf title='해당열 너비조절' style='width:40;height:15px;font-size:10px;'> <span onclick=\"Alice.table.rapWidthCol('"+alice+"','"+tid+"')\" style='cursor:pointer'>입력</span></td></tr>"+
						"<tr><td colspan=4 height=1 bgcolor=#dddddd></td></tr>"+
	...
	popupTable: function() {
		...
		var txt = ""+			
			...
			"<table border=0 width=100% cellspacing=0 cellpadding=0 class=alc-pop-bs0>"+				
				"<tr height=25>"+
					...
					"<td width=25%><input type=text id=twidth size=4 value=400> <select id=tsize><option value=picxel>픽셀</option><option value=percentage>퍼센트</option></select></td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>세로줄</li></td>"+
					"<td><input type=text id=tcol size=4 value=3></td>"+
					"<td><li>높이</li></td>"+
					"<td><input type=text id=theight size=4 value=100> 픽셀</td>"+
				"</tr>"+
				"<tr height=25>"+
					"<td><li>테두리 크기</li></td>"+
				...
				"<tr height=25>"+
					...
					"<td colspan=3>"+
					 "<table border=0>"+
					 	"<tr bgcolor=#ffffff>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"')\"                               border=1 cellspacing=0 cellpadding=0><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"',null,null,'#eeeeee')\"           border=1 cellspacing=0 cellpadding=0><tr bgcolor=#eeeeee><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','black','#ffffff')\"             border=1 cellspacing=0 cellpadding=0 bordercolorlight=black bordercolordark=#ffffff><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','black','#ffffff','#eeeeee')\"   border=1 cellspacing=0 cellpadding=0 bordercolorlight=black bordercolordark=#ffffff><tr bgcolor=#eeeeee><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#555555','#ffffff')\"           border=1 cellspacing=0 cellpadding=0 bordercolorlight=#555555 bordercolordark=#ffffff><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#555555','#ffffff','#eeeeee')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#555555 bordercolordark=#ffffff><tr bgcolor=#eeeeee><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#999999','#ffffff')\"           border=1 cellspacing=0 cellpadding=0 bordercolorlight=#999999 bordercolordark=#ffffff><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#999999','#ffffff','#eeeeee')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#999999 bordercolordark=#ffffff><tr bgcolor=#eeeeee><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	"</tr>"+
					 	"<tr bgcolor=#ffffff>"+
				 	 		"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#4F81BD','#D0D8E8','#E9EDF4')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#4F81BD><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#D0D8E8><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#E9EDF4><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
				 	 		"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#000000','#CBCBCB','#E7E7E7')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#000000><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#CBCBCB><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#E7E7E7><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#C0504D','#E8D0D0','#F4E9E9')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#C0504D><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#E8D0D0><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#F4E9E9><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#9BBB59','#DEE7D1','#EFF3EA')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#9BBB59><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#DEE7D1><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#EFF3EA><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#8064A2','#D8D3E0','#EDEAF0')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#8064A2><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#D8D3E0><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#EDEAF0><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#EDEAF0','#D0E3EA','#E9F1F5')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#EDEAF0><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#D0E3EA><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#E9F1F5><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#F79646','#FCDDCF','#FDEFE9')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#F79646><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#FCDDCF><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#FDEFE9><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
					 	 	"<td style='border:1px solid white' onmouseover=\"this.style.border='1px solid #709DBC'\" onmouseout=\"this.style.border='1px solid white'\"><table style=cursor:pointer onclick=\"Alice.table.template('"+this.aliceId+"','#ffffff','#ffffff','#FDEFE9','#CCFFCC','#FFFFCC')\" border=1 cellspacing=0 cellpadding=0 bordercolorlight=#ffffff bordercolordark=#ffffff><tr bgcolor=#FDEFE9><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#CCFFCC><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr><tr bgcolor=#FFFFCC><td width=20>&nbsp;</td><td width=20>&nbsp;</td></tr></table></td>"+
				 	"</tr>"+
					 "</table>"+
					"</td>"+
				"</tr>"+				
		...
		Web.popup({title:'테이블 설정',msg:txt,width:570,height:400});
		Web.Form.setStyle("aliceForm");
	},
				...
				"<tr>"+
					...
					"<td colspan=3>"+
						"<table border=0 cellspacing=0 cellpadding=0 style=font-size:9pt>"+
						    "<tr>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#eeeeee','solid','#999999')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#eeeeee;width:50;height:40;margin :0;padding:0;'><center><br>필드셋</center></fieldset></td>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#eeeeee','none','#999999')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#eeeeee;width:50;height:40;margin :0;padding:0;border:none'><center><br>필드셋</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#eeeeee','dotted','#999999')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#eeeeee;width:50;height:40;margin :0;padding:0;border:1px dotted #999999'><center><br>필드셋</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#CAE5FF','solid','#90C8FF')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#CAE5FF;width:50;height:40;margin :0;padding:0;border:1px solid #90C8FF'><center><br>필드셋</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#CAE5FF','dotted','#90C8FF')\" onmouseover=this.style.color='red' onmouseout=this.style.color='' style='cursor:pointer;background-color:#CAE5FF;width:50;height:40;margin :0;padding:0;border:1px dotted #90C8FF'><center><br>필드셋</center></fieldset>"+
							"<td style=padding-right:4px><fieldset onclick=\"Alice.fieldset.template('"+this.aliceId+"', '#ffffee','solid','#999999','#660066')\" onmouseover=this.style.color='red' onmouseout=this.style.color='#660066' style='cursor:pointer;background-color:#ffffee;width:50;height:40;margin :0;padding:0;color:#660066'><center><br>필드셋</center></fieldset>"+
...
Alice.image = {
	...
	upload: function() {
		...
		var fnm = $("alc-image-upload").value;
		...
		if (!Web.Form.validateFile("alc-image-upload", "gif", "jpg", "png", "jpeg")) {
			Web.alert({title:'경고',msg:'GIF,JPG,PNG,JPEG 파일만 업로가 가능합니다'});
			return;	
		}
	...
	apply: function(id) {
		...
		var img = "<img src="+$("alc-image-preview").src+" name=alc-images "+
					...
					"'>"+
					($("alc-image-break").checked? "<br clear=all></br>":"");
...
Alice.flash = {
	...
	upload: function() {
		...
		var fnm = $("alc-flash-upload").value;
		fnm = fnm.substring(fnm.lastIndexOf('\\')+1);
		for (var i = 0; i < fnm.length; i++) {
			if ("!@#$%^&*,;:'\"?=".indexOf(fnm.substring(i, i + 1)) > -1) {
				alert('파일명에 특수문자가 들어가면 안됩니다');
...
Alice.table = {
	...
	initialize: function() {
		...
		this.rwidth = !$("twidth").present()? 400:($("tsize").value == 'picxel' ? parseInt($("twidth").value):600);
		this.rheight = !$("theight").present()? 100:parseInt($("theight").value);
	},
	...
	heightRow: function(id,t,add) {
		...
		if (el) {
			...
			if (nhei == '') return;
			nhei = parseInt(nhei);
			if (nhei > add) padd = (nhei - add)*-1;
			else padd = add - nhei;
			if (tab.height == '') return;
	...
	rapWidthCol: function(id,t) {
		if (!Web.Form.validateValue('unc-tab-wid-conf')) return;
		if (!Web.Form.validateNum('unc-tab-wid-conf')) return;
		
		Alice.table.widthCol(id,t,$('unc-tab-wid-conf').value);
	},
	
	rapHeightCol: function(id,t) {
		if (!Web.Form.validateValue('unc-tab-hei-conf')) return;
		if (!Web.Form.validateNum('unc-tab-hei-conf')) return;		
		Alice.table.heightRow(id,t,$('unc-tab-hei-conf').value);
	},
