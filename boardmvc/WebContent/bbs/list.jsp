...
<body>
	...
	<form name="searchForm" method="post"
		action="javascript:goBbsSearch();" style="margin: 0px">
		...
		<table width="100%" cellpadding="0" cellspacing="0" border="0">
			...
			<tr>
				...
				<td nowrap><select name="item" onchange="javascript:ch()"
				...
				</span> <span id="sear2" style="display: none;"> <select name="head"
						class="inp">
							<option value="말머리선택">말머리선택
					</select>
				</span> <a href="javascript:goBbsSearch();"><img
					...
					href="javascript:goMyList('안효인')"><img
						...
						align="absmiddle" alt="내가 쓴 글 보기"></a><br></td>
