...
-->
			...
			<tr>
			 ...
			 <td class="td4">
			 <input type="text" name="id" id="userid" value="" size="12" onkeyup="javascript:idcheck();">
			 <div id="idresult"></div> 
			 </td>
			</tr>
			...
			<tr>
	         ...
	         <td class="td3"><input type="password" name="pass" id="userpass" size="12" maxlength="12">&nbsp;&nbsp;<font color="#3cb371">6~12</font>자리의 영문(대소문자 구별)이나 숫자</td>
			</tr>
